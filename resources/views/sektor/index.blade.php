    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
          ...
          <a href="#" class="btn btn-info pull-right" data-toggle="modal" data-target="#tambah-data"><i class="fa fa-plus"></i> Tambah Sektor</a>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
                ...
                <div class="modal-dialog modal-sm" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      <form class="form-horizontal" method="POST" action="{{ route('sektor-delete', $dt->id) }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-header">
                      ...
                      <div class="modal-body">
                        ...
                        @endif
                        <!-- form start -->
                        <form method="POST" role="form" action="{{ route('sektor-update', $dt->id) }}" enctype="multipart/form-data">
                          @csrf
                          <div class="box-body">
          ...
          <div class="modal-content">
            <div class="modal-header">
              ...
              <div class="modal-body">
                ...
                <form method="POST" role="form" action="{{ route('sektor-store') }}" enctype="multipart/form-data">
                  @csrf
                  <div class="box-body">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Nama</label>
                    ...
                    <div class="form-group">
                      <label for="exampleInputEmail1">Gereja</label>
                      <select name="gereja_id" id="" class="form-control">
                        <option value="gereja_id">-- Pilih --</option>
                        @foreach ($gereja as $key =>$value)
                        <option value="{{$key}}">{{$value}}</option>
                        @endforeach
                      </select>
