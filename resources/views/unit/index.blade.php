            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <th class="text-center">Ketua Unit</th>
                ...
                <tbody>
                  ...
                  <td class="text-center">{{$dt->ketua_unit}}</td>
 ...
 {{-- Modal EDIT Start --}}
        ...
        <form method="POST" role="form" action="{{ route('unit-update', $dt->id) }}" enctype="multipart/form-data">
            @csrf
              ...
              <div class="form-group">
                  <label for="exampleInputEmail1">Ketua Unit</label>
                <input type="text" class="form-control{{ $errors->has('ketua_unit') ? ' is-invalid' : '' }}" placeholder="Ketua Unit" name="ketua_unit" value="{{$dt->ketua_unit}}">
            </div>
              </div>
              </div>
              <div class="modal-footer">
        ...
        <!-- /.col -->
          ...
          <div class="modal-dialog">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                  <label for="exampleInputEmail1">Ketua Unit</label>
                <input type="text" class="form-control{{ $errors->has('ketua_unit') ? ' is-invalid' : '' }}" placeholder="Ketua Unit" name="ketua_unit" value="{{old('ketua_unit')}}">
            </div>
              </div>
                {{-- end form --}}
              </div>
