    ...
    <section class="content">
      <div class="box">
        <div class="box-header">
          <h3 class="box-title">Data Jadwal Ibadah</h3>
          <div class="pull-right">
            <a href="{{ route('jadwal-ibadah-create') }}" class="btn btn-primary"> <i class="fa  fa-plus-square"></i> Tambah Jadwal </a>
          </div>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
          <table id="example2" class="table table-bordered table-striped">
            ...
            <tr>
              ...
              <td class="text-center">{{$dt->nama_ibadah}}</td>
              ...
              <td class="text-center">
                    <a href="{{ route('jadwal-ibadah-edit', $dt->id) }}" class="btn btn-info btn-xs"> <i class="fa fa-edit"></i> Edit</a>
                            ...
                            <div class="modal-dialog modal-sm" role="document">
                              <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                   <form class="form-horizontal" method="POST" action="{{ route('jadwal-ibadah-delete', $dt->id) }}" enctype="multipart/form-data">
                                    {{ csrf_field() }}
