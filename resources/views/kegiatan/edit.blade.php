...
<form method="POST" action="{{ route('kegiatan-update') }}" enctype="multipart/form-data" class="form-horizontal">
@csrf
...
<div class="form-group">
 ...
 <div class="form-group">
    ...
    <div class="col-sm-6">
    <input type="text" class="form-control" id="datepicker" name="tanggal" value="{{$data->tanggal}}" placeholder="Tanggal Kegiatan">
    </div>
</div>
 <div class="form-group">
 ...
 <div class="form-group">
    ...
    <div class="col-sm-6">
    <input type="text" class="form-control" name="tempat" value="{{$data->tempat}}" placeholder="Tempat Kegiatan">
    </div>
</div>
 <div class="form-group">
