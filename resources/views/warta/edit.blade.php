    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-default">
                ...
                <form method="POST" action="{{ route('warta-update') }}" enctype="multipart/form-data" class="form-horizontal">
                    @csrf
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" rows="5" name="isi_berita">{{$data->isi_warta}}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="file" class="form-control" placeholder="Gambar" name="dokumen">
                            </div>
                        </div>
                    </div>
